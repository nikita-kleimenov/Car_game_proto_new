...
namespace ButchersGames.BarrierTransitions
{
    public class BarrierMoveTransition : MonoBehaviour
    {
        ...
        [SerializeField] private float _transitDurationTo;
        [SerializeField] private float _transitDurationFrom;
        [SerializeField] private float _pauseDurationStart;
        [SerializeField] private float _pauseDurationEnd;
        ...
        private void Transition(bool isLeftSide)
        {
            ...
            Target.DOMove(target, isLeftSide ? _transitDurationFrom : _transitDurationTo)
        ...
        {
            yield return new WaitForSeconds(isLeftSide ? _pauseDurationStart : _pauseDurationEnd);
